...
Copy-paste recipes for common tasks. Concepts behind them: [Quickstart](/docs/quickstart), [Browser automation](/docs/automation/browser), [Extraction](/docs/search/extraction).
...
omniscout memory "what did I read about agents?"
