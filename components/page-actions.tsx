...
import { ChevronDown, ExternalLinkIcon, MessageSquare, TextIcon } from 'lucide-react';
  ...
  const items = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        icon: (
          <>
            <span className="brand-light inline-flex">
              <svg viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg" role="img">
                <title>Grok</title>
                <path
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 296 298" xmlns="http://www.w3.org/2000/svg" fill="none" role="img">
            <title>Gemini</title>
            <mask
              id="fx-gemini-a"
              width="296"
      ...
      },
      {
        ...
        icon: <MessageSquare style={{ width: 12, height: 12, color: '#812C50' }} fill="#FFAAFC" />,
      },
      {
        title: 'Open in DeepSeek',
        href: `https://chat.deepseek.com/?${new URLSearchParams({ q })}`,
        icon: (
