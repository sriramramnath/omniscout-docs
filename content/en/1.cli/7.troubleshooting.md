...
```bash
# Viewport-only by default — use --full-length for content below the fold
omniscout browser screenshot https://example.com --full-length --out page.png

# Loading spinner still visible — wait before capture
omniscout browser screenshot https://example.com --delay 3 --out page.png
